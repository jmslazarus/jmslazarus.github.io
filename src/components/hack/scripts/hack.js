elation.require([
  ...
  elation.component.add("hack.terminal", function() {
    ...
    this.init = function() {
      ...
      this.connection = new WebSocket('wss://jlazarus.vercel.app:8086/terminal/terminal');
  ...
  elation.component.add("hack.zuulpics", function() {
    ...
    this.init = function() {
      ...
      this.tabs = elation.ui.tabbedcontent({
        ...
        animation: 'fade',
        items: [
          { label: 'Zuul 1', name: 'zuul1', content: '<img src="src/images/shared/zuul1.jpg" />' },
          { label: 'Zuul 2', name: 'zuul2', content: '<img src="src/images/shared/zuul2.jpg" />' },
          { label: 'Zuul 3', name: 'zuul3', content: '<img src="src/images/shared/zuul3.jpg" />' },
          { label: 'Zuul 4', name: 'zuul4', content: '<img src="src/images/shared/zuul4.jpg" />' },
          { label: 'Zuul 5', name: 'zuul5', content: '<img src="src/images/shared/zuul5.jpg" />' }
        ]
      });
    }
  }, elation.ui.base);
